...
[cite_start]En la versión antigua, existía un único "dictador" llamado **JobTracker** [cite: 271-272]. Este componente tenía que hacerlo todo:
...
La solución fue **dividir responsabilidades**. [cite_start]Nace **YARN** (Yet Another Resource Negotiator), que actúa como el Sistema Operativo del clúster [cite: 260-267].
...
* **Misión:** Es el autoridad máxima de los recursos. Gestiona la RAM y CPU de todo el clúster.
* **Función:** No sabe *qué* estás ejecutando. [cite_start]Solo recibe peticiones ("Necesito 4GB de RAM") y las aprueba o deniega [cite: 306-308].
...
* **Función:** Negocia los recursos con el Resource Manager y luego da las órdenes a los Node Managers. [cite_start]Cuando el trabajo termina, este jefe "desaparece" [cite: 320-321].
...
* **Importante:** El Mapper **NO suma** ni cuenta totales. Es "tonto" y rápido. [cite_start]Solo dice: "He visto un pepe" (`pepe, 1`) [cite: 860-862].

### Fase 2: Shuffle & Sort (El Organizador)
* **Proceso:** Es automático (caja negra de Hadoop).
* [cite_start]**Acción:** Recoge todas las salidas de los miles de Mappers, las **ordena** alfabéticamente y las **agrupa** por clave[cite: 533].
* [cite_start]**Resultado:** Al Reducer no le llegan datos sueltos, le llega la clave con todos sus valores juntos (Ej: `pepe, [1, 1, 1]`)[cite: 533].
...
* [cite_start]**Salida:** El resultado final que se guarda en HDFS [cite: 589-590].
